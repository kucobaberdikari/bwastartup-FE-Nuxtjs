<template>
  <div class=" bg-gray-50 text-gray-800 absolute rounded-lg">
    <div class=" top-0 left-0 w-64 bg-gray-200 h-full border-r border border-gray-50 rounded-lg">
      <div class="overflow-y-auto overflow-x-hidden flex-grow">
        <ul class="flex flex-col py-4 space-y-1">
          <li>
            <a href="#" class="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-iris pr-6">
